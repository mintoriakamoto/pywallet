...
COIN_PARAMS = {
    ...
    'PHR':   ('Phore',             0x37, 0xd4, 0x0d, None),
    'SMART': ('SmartCash',         0x3f, 0xbf, 0x12, None),
    'LBC':   ('LBRY Credits',      0x55, 0x1c, 0x7a, None),
    ...
    'LCC':   ('Litecoin Cash',     0x1c, 0xb0, 0x05, None),
